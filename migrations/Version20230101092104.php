 ...
 */
final class Version20230101092104 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE facility (id INT AUTO_INCREMENT NOT NULL, address_id INT NOT NULL, customer_id INT NOT NULL, name VARCHAR(255) NOT NULL, public_message_fr LONGTEXT NOT NULL, public_message_en LONGTEXT NOT NULL, UNIQUE INDEX UNIQ_105994B2F5B7AF75 (address_id), INDEX IDX_105994B29395C3F3 (customer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
